            ...
            <form action="#" className="connect-card__form">
              ...
              <div className="connect-card__block">
                ...
                <div className="connect-card__block__bottom">
                  <input type="text" id="connect-card__input2" placeholder="05" maxLength="2" className="connect-card__form__input2" />
                  <input type="text" id="connect-card__input3" placeholder="2023" maxLength="4" className="connect-card__form__input3" />
                  <input type="text" id="connect-card__input4" placeholder="834" maxLength="3" className="connect-card__form__input4" />
                </div>
              </div>
